...
//       print_r($xml);
    class TASiteInterface {
        ...
        public function ConstructArray(){
          ...
          //  print_r($arr);
            foreach($OrgArr as $tempArr){
                ...
                $arr[]=array($title,"",$imgUrl,$targetUrl);
        ...
        private function ConstructHead(){ 
            $WeSiteName=WeSiteName;
            $URL=URL;
            $ImgUrl = "http://7.sum41.sinaapp.com/subpage/HomePage.php";
            $taguid=TAGUID;
            $arr=array($WeSiteName,"",$URL."/App.TASite/admin/Images/".$taguid."/SidImage/banner.jpg",$ImgUrl);
            return $arr;
        }
    }
/* 
